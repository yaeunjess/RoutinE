                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      for (int i = 0; i < widget.exercises.length; i++) {
                        ...
                        if (exercise.counterType == CounterType.isDual) {
                          var exerciseState = context.read<ExerciseDualState>();
                          ...
                          var exerciseState = context.read<ExerciseSingleState>();
                      ...
                      for (var record in records) {
                        final companion = RecordsCompanion(
                          ...
                          achievementCounts: Value(record.achievementCounts?.toString() ?? '[]'),
                        );
